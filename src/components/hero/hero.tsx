         ...
         <div className="flex max-md:flex-col items-center">
            <div className="flex-col ">
              ...
              <div className='flex sm:gap-14 gap-8 md:mt-8 mt-4 text-center font-medium text-[15px]'>
                <div className='text-black bg-white rounded-lg py-1.5 px-3 text-center whitespace-nowrap font-semibold md:text-lg text-md'>Book an appointment</div>
                <div className='bg-[#0066cc] rounded-lg py-1.5 px-3 text-center h-fit text-white'>Login/Signup</div>
              </div>
            </div>
